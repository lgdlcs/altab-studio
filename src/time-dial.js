...
const KEYFRAMES = [
  ...
  },
  {
    ...
    treeline: '#100818', stars: 0.03, moon: 0, isDark: true,
  },
  {
    hour: 10,
    bg: '#e8eef5', bgSec: '#dce4ee', text: '#1e293b', textSec: '#475569', textMuted: '#94a3b8',
    sky: ['#1854b0', '#3080e0', '#60a5fa', '#a0d0f0'],
    lake: ['#4090d0', '#1854b0'],
    mtFar: ['#4a7c5e', '#3a6a50'], mtMid: ['#305540', '#204435'], mtNear: ['#1a3828', '#102a1a'],
    treeline: '#0d2015', stars: 0, moon: 0, isDark: false,
  },
  {
    hour: 14,
    ...
    treeline: '#0a1810', stars: 0, moon: 0, isDark: false,
  },
  {
    hour: 18,
    bg: '#150a22', bgSec: '#1e1032', text: '#f0e8f5', textSec: '#b898c8', textMuted: '#806898',
    sky: ['#100530', '#6020a0', '#c04080', '#ff7030'],
    lake: ['#8030a0', '#100530'],
    mtFar: ['#2d1550', '#201040'], mtMid: ['#1a0d38', '#130830'], mtNear: ['#100825', '#0a051a'],
    treeline: '#080418', stars: 0.12, moon: 0, isDark: true,
  },
  {
    hour: 21,
    bg: '#050810', bgSec: '#0a0f1a', text: '#f1f5f9', textSec: '#94a3b8', textMuted: '#64748b',
